...
class UserFollowsAdapter : RecyclerView.Adapter<UserFollowsAdapter.UserViewHolder>(){
    ...
    fun setList(users: ArrayList<User>){
        val diffResult = DiffUtil.calculateDiff(FollowDiffUtilCallback(list, users))
        list.clear()
        list.addAll(users)
...
class FollowDiffUtilCallback(private val oldList: ArrayList<User>, private val newList: ArrayList<User>) : DiffUtil.Callback() {
